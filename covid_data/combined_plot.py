...
ax3.set_xticks(np.arange(2, 8.5, 1))
ax3.set_xlim(4,8.5)
...
ax4.set_xlim(0,22)
ax4.set_xticks(np.arange(0, 22, 5))
...
ax5.set_xlim(0,22)
ax5.set_xticks(np.arange(0, 22, 5))
...
ax6.set_xlim(0,22)
ax6.set_xticks(np.arange(0, 22, 5))

# Add a suptitle and save the figure
plt.suptitle("COVID-19 Incubation Period Estimation (Comparison)", size=20, y=0.99)
plt.tight_layout()
...
names = [r"$\bf{A.}$ Direct Sampling Gamma Distribution (COVID-19)",
         r"$\bf{B.}$ MvN-approx Gamma Distribution (COVID-19)",
         r"$\bf{C.}$ Meta-analysis Gamma Distribution (COVID-19)",] 
...
names = [r"$\bf{A.}$ Direct Sampling (COVID-19)",
         r"$\bf{B.}$ MvN-approx (COVID-19)",
         r"$\bf{C.}$ Meta-analysis (COVID-19)",] 
